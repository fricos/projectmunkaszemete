<template>
  <div class="div_class">
    <h3>Átirányítás a fizetési oldalra</h3>

    <div class="alert alert-primary" role="alert">
      Kártyás fizetéshez irja be a kártya számát pl.: 4242-4242-4242-4242 és cvc-kódot pl.: 123
    </div>
...
export default {
  data() {
    return {
      stripeAPIToken: process.env.VUE_API_STRIPETOKEN,
      stripe: '',
      token: null,
      sessionId: null,
      checkoutBodyArray: [],
